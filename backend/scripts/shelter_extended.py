...
# Function to fetch the shelters/places from API given query (county)
...
# Make sure to get enough places form the query
...
# Given the place id for a shelter get details of the place
...
# Given place id, get photo of the shelter
...
# Gets the reference for the photo of the shelter
...
# Construct a url for the photo of the place
...
def main():
    ...
    # Get all shelters/places and perform any needed processing
    for place in places:
        ...
        # If the place is still a valid shelter get further details 
        # and save an entry for it
    ...
    # Write all the shelters/places to a JSON and save it
