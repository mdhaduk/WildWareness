    ...
    return (
        <div className="container">
            <div className="row w-100">
                ...
                <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel" style={{ maxWidth: '900px', maxHeight: '500px', marginTop: "100px"}} data-testid="carousel">
                ...
                <div className="row row-cols-1 row-cols-md-3 d-flex justify-content-center g-4">
                    ...
                    <div className="card" style={{ width: '22rem', height: '26rem'}}>
                        {/* Image */}
                        <img className="card-img-top mx-auto" style={{width: "200px", height: "200px", marginTop: "18px", padding: "0", marginBottom: "38px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-l6wNUpAcbN_I-awMgWQEt5k02D9pYFDJ1Q&s" />
