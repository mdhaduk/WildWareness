...
const WildfireIncidentsPage = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      <div className="status-indicator mt-2 mb-3">
        <span className={`badge ${wildfire.ongoing ? 'bg-danger' : 'bg-success'} rounded-pill px-4 py-2`} style={{fontSize: '1rem', fontWeight: 'bold'}}>
          {wildfire.ongoing ? 'ONGOING FIRE' : 'CONTAINED FIRE'}
        </span>
      </div>
      ...
      <div className="container-fluid my-4">
        ...
        <ul className="list-group list-group-flush">
          ...
          <li className="list-group-item text-wrap">
            ...
            <span className={`badge ${wildfire.ongoing ? 'bg-danger' : 'bg-success'} rounded-pill px-3 py-2`} style={{fontSize: '0.9rem', fontWeight: 'bold'}}>
              {wildfire.ongoing ? 'ONGOING' : 'CONTAINED'}
            </span>
          </li>
        </ul>
      </div>
